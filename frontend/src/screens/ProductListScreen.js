...
function ProductListScreen({ history, match }) {
    ...
    }, [dispatch, history, userInfo, successDelete, successCreate, createdProduct])//if one of these changed we want to run useEffect again. like successDelete changes. so list users would reload
